    ...
    function commands(data) {
        ...
        switch(data){
            ...
            case "/credits":
                ...
                $('#credits').append('<div class="CTitle">NoobScript-331</div><div class="CSep"></div><div class="CBody">Made By</div><div class="CSep"></div><div class="CBody">SnakedMusique</div><a class="CLink" href="https://www.youtube.com/user/SnakedMusique" target="_blank">YouTube</a><div class="CSep"></div><div class="CBody">&</div><div class="CSep"></div><div class="CBody">donvoo</div><a class="CLink" href="https://www.youtube.com/channel/UCbb-SEWOIg1fBo6LZCK5CBg" target="_blank">YouTube</a><div class="CSep"></div><h3 class="CInfo">Hello!<br>Thank you for using NoobScript... We thank you from the bottom of our hearts! NoobScropt was created to make the joys of plug even better! We hope you enjoy our work!</h3><div class="CSep"></div><h3 class="CInfo">Please do not edit our script without our permission... <br>Because that would be like... stealing our work! We do not want that! :P</h3><div class="CSep"></div><div class="CTitle">Thank You!</div><div class="CClose">X</div>');
